...
If you have no partitioning layer, the companion plugin **[IB-Tool (Partitioning)](https://github.com/IB-Tool/Partitioning)** derives one from building footprints and writes exactly the `PART_<number>` format described above.
